...
class Staff extends Worker {
    ...
    public void cetakKaryawan() {
        System.out.println(getIdKaryawan() + "\t" + getNamaKaryawan() + "\t" + getJabatanKaryawan());

    }
    public void cetakAbsen(){
        System.out.println(getIdKaryawan()+"\t"+getNamaKaryawan()+"\t"+getJabatanKaryawan()+""+absen);
    }
